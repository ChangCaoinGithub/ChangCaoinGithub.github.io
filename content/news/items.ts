...
export const news = [
  { date: "08.2026", title: createElement("span", null, "Joined the core team of ", createElement("a", {className: "body-link", href: "https://catalyst-app.org/", target: "_blank", rel: "noreferrer" }, "Catalyst"), " as the Max Planck Society liaison!"), type: "Social Activities" },
  ...
  { date: "05.2026", title: createElement("span", null, "Our paper, ", createElement("a", {className: "body-link", href: "https://is.mpg.de/esi/publications/cao26-aom", target: "_blank", rel: "noreferrer" }, "“The Role-Sensitive Nature of Gaze: Listener Engagement in Natural Group Interaction”"), ", has been accepted for presentation in the seminar “Who Gets Seen as a Leader? Signals, Status, and AI in Modern Organizations” at the 2026 Annual Meeting of the Academy of Management. See you in Philadelphia this July!"), type: "Research" },
  ...
  { date: "10.2022", title: "Started my M.Sc. in Cognitive Science at the University of Tübingen (UT)!", type: "Education" },

  { date: "06.2021", title: "Graduated with a B.Sc. in Applied Psychology from SMU, with a thesis graded 4.0/4.0!", type: "Education" },

  { date: "2020", title: "Volunteered as psychological supporter during the COVID-19 pandemic.", type: "Social Activities" },
  { date: "2020", title: "Awarded scholarship from SMU.", type: "Award" },
  { date: "2020", title: "Awarded Honor Student from SMU.", type: "Award" },
